...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        for i in range(10):  # Change this number for more or fewer users
            ...
            latitude = random.uniform(13.7, 13.8)  # Random latitude
            longitude = random.uniform(100.5, 100.6)  # Random longitude
